...
namespace Attendence_System
{
    public partial class frmAttendance : Form
    {
        ...
        {
            webBrowser1.Navigate(Application.StartupPath + "\\Flash\\at.swf", false);
            show_data();
            textBox1.DataBindings.Add("Text", dt, "attendence_id");
            dateTimePicker1.DataBindings.Add("Text", dt, "att_date");
            textBox2.DataBindings.Add("Text", dt, "emp_code");
            textBox3.DataBindings.Add("Text", dt, "is_present");
        ...
        {
            frmAttendance_List attn = new frmAttendance_List();
            attn.ShowDialog();
        }
