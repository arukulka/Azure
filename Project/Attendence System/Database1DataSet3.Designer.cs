...
namespace Attendence_System.Database1DataSet3TableAdapters {
...
SELECT salary_id, month, year, emp_code, emp_name, w_day, p_day, basic, da, hra, ma, pha, hma, pf, pt, loan, oa, arriars, oded, grins, advit, gross, tot_ded, netsal, remark FROM salary WHERE (salary_id = SCOPE_IDENTITY())";
        ...
        public virtual int Fill(Database1DataSet3.salaryDataTable dataTable) {
        ...
        public virtual Database1DataSet3.salaryDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database1DataSet3.salaryDataTable dataTable = new Database1DataSet3.salaryDataTable();
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database1DataSet3.salaryDataTable dataTable) {
