...
namespace Attendence_System
{
    public partial class frmScale : Form
    {
        ...
        {
            webBrowser1.Navigate(Application.StartupPath + "\\Flash\\s.swf",false);
            ...
            textBox1.DataBindings.Add("Text", dt, "scale_id");
            textBox2.DataBindings.Add("Text", dt, "Month");
            textBox3.DataBindings.Add("Text", dt, "Year");
            textBox4.DataBindings.Add("Text", dt, "Da_per");
            textBox5.DataBindings.Add("Text", dt, "Hra_per");
            textBox6.DataBindings.Add("Text", dt, "Ma_per");
            textBox7.DataBindings.Add("Text", dt, "Pha_per");
            textBox8.DataBindings.Add("Text", dt, "Hma_per");
            textBox9.DataBindings.Add("Text", dt, "Pf_per");
            textBox10.DataBindings.Add("Text", dt, "Pt_per");
            conn.Close();
        ...
        {
            frmScale_List ssl = new frmScale_List();
            ssl.ShowDialog();
