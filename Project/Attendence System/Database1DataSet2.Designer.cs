...
namespace Attendence_System.Database1DataSet2TableAdapters {
    ...
    public partial class employeeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[employee] WHERE (([emp_id] = @Original_emp_id) AND ((@IsNull_e" +
                ...
                " [emp_type] IS NULL) OR ([emp_type] = @Original_emp_type)) AND ([last_instituten" +
                "ame] = @Original_last_institutename) AND ((@IsNull_qualification = 1 AND [qualif" +
                "ication] IS NULL) OR ([qualification] = @Original_qualification)) AND ((@IsNull_" +
                "experience = 1 AND [experience] IS NULL) OR ([experience] = @Original_experience" +
                ")) AND ([phy_hand] = @Original_phy_hand) AND ((@IsNull_remark = 1 AND [remark] I" +
                "S NULL) OR ([remark] = @Original_remark)) AND ((@IsNull_pan_no = 1 AND [pan_no] " +
                "IS NULL) OR ([pan_no] = @Original_pan_no)) AND ((@IsNull_department = 1 AND [dep" +
                "artment] IS NULL) OR ([department] = @Original_department)))";
...
SELECT emp_id, emp_code, name, address, city, pincode, phone, mobile, email, bloodgroup, designation, basic, birthdate, joindate, bank_ac, scale, category, gpfno, emp_type, last_institutename, qualification, experience, phy_hand, remark, pan_no, department FROM employee WHERE (emp_id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[employee] SET [emp_code] = @emp_code, [name] = @name, [address] = @" +
                ...
                ")) AND ([last_institutename] = @Original_last_institutename) AND ((@IsNull_quali" +
                "fication = 1 AND [qualification] IS NULL) OR ([qualification] = @Original_qualif" +
                "ication)) AND ((@IsNull_experience = 1 AND [experience] IS NULL) OR ([experience" +
                "] = @Original_experience)) AND ([phy_hand] = @Original_phy_hand) AND ((@IsNull_r" +
                "emark = 1 AND [remark] IS NULL) OR ([remark] = @Original_remark)) AND ((@IsNull_" +
                "pan_no = 1 AND [pan_no] IS NULL) OR ([pan_no] = @Original_pan_no)) AND ((@IsNull" +
                "_department = 1 AND [department] IS NULL) OR ([department] = @Original_departmen" +
                "t)));\r\nSELECT emp_id, emp_code, name, address, city, pincode, phone, mobile, ema" +
                "il, bloodgroup, designation, basic, birthdate, joindate, bank_ac, scale, categor" +
                "y, gpfno, emp_type, last_institutename, qualification, experience, phy_hand, rem" +
                "ark, pan_no, department FROM employee WHERE (emp_id = @emp_id)";
        ...
        public virtual int Delete(
            ...
            if ((Original_last_institutename == null)) {
                throw new global::System.ArgumentNullException("Original_last_institutename");
            }
            else {
                this.Adapter.DeleteCommand.Parameters[37].Value = ((string)(Original_last_institutename));
            }
            if ((Original_qualification == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[39].Value = ((string)(Original_qualification));
            }
            if ((Original_experience == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[41].Value = ((string)(Original_experience));
            }
            if ((Original_phy_hand == null)) {
                throw new global::System.ArgumentNullException("Original_phy_hand");
            }
            else {
                this.Adapter.DeleteCommand.Parameters[42].Value = ((string)(Original_phy_hand));
            }
            ...
            if ((Original_pan_no == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[46].Value = ((string)(Original_pan_no));
            }
            if ((Original_department == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[48].Value = ((string)(Original_department));
            }
        ...
        public virtual int Insert(
            ...
            if ((last_institutename == null)) {
                throw new global::System.ArgumentNullException("last_institutename");
            }
            else {
            ...
            if ((phy_hand == null)) {
                throw new global::System.ArgumentNullException("phy_hand");
            }
            else {
        ...
        public virtual int Update(
            ...
            if ((Original_last_institutename == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[62].Value = ((string)(Original_last_institutename));
            }
            if ((Original_qualification == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[64].Value = ((string)(Original_qualification));
            }
            if ((Original_experience == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[66].Value = ((string)(Original_experience));
            }
            if ((Original_phy_hand == null)) {
                throw new global::System.ArgumentNullException("Original_phy_hand");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[67].Value = ((string)(Original_phy_hand));
            }
            if ((Original_remark == null)) {
            ...
            if ((Original_pan_no == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[71].Value = ((string)(Original_pan_no));
            }
            if ((Original_department == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[73].Value = ((string)(Original_department));
            }
            this.Adapter.UpdateCommand.Parameters[74].Value = ((int)(emp_id));
