...
namespace Attendence_System
{
    public partial class frmLeave : Form
    {
        ...
        {
            webBrowser1.Navigate(Application.StartupPath + "\\Flash\\ld.swf",false);
            ...
            textBox1.DataBindings.Add("Text", dt, "Leave_id");
            dateTimePicker1.DataBindings.Add("Text", dt, "Leave_date");
            textBox2.DataBindings.Add("Text", dt, "Emp_id");
            textBox3.DataBindings.Add("Text", dt, "Emp_name");
            textBox4.DataBindings.Add("Text", dt, "Leave_type");
            textBox5.DataBindings.Add("Text", dt, "Leave_resion");
            conn.Close();
        ...
        {
            frmLeave_List ll = new frmLeave_List();
            ll.ShowDialog();
        }   
